...
// Setst the value of userInput to the user's entry 
let userInput = prompt(q1);

// 1st Conditional Statement
// Note: Prompt returns the value entered as a string. That is why double equals == is used instead of tripe equals === here. 
if (userInput == 1) {
    userInput = prompt(q2);
